...
На чистой OpenWrt сначала установите системную утилиту, которой adapter проверяет
владельца и права rollback-capability:
...
Installer проверяет наличие `stat` до копирования файлов. Xray и совместимый
`nfqws` устанавливаются отдельно до первой dataplane-транзакции.
