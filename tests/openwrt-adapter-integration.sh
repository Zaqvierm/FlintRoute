...
# This script exercises adapter logic in a non-root temporary fixture.  The
# production adapter still requires root:daemon ownership; this explicit
# fixture-only mode keeps the Linux CI test focused on transaction semantics
# without hiding ownership failures in production.
...
export ROUTER_POLICY_ALLOW_SIMULATED_DIAGNOSTICS ROUTER_POLICY_AUTO_COLLECT_EVIDENCE ROUTER_POLICY_ADAPTER_LIB_ONLY MOCK_UCI_STATE MOCK_IP_STATE MOCK_SERVICE_STATE
